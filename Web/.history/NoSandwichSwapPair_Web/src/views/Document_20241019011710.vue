  ...
  data() {
    return {
      menuItems: [
        ...
        {
          title: 'Team(No order of priority)' ,
          isOpen: false,
          sectionId: 2,
          sections: [
            { name: 'Artist Zhou', subSectionId: 1 },
            { name: 'Fox(张谦)', subSectionId: 2 },
            {name: 'SegmentOverflow', subSectionId: 3},
            { name: 'Treap', subSectionId: 4 },
            { name: 'Xi77jWhy', subSectionId: 5 },
            {name: 'Jawk', subSectionId: 6},
